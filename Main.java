...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("input.txt file is scanned successfully");
    sc.close();
    ...
    fw.write("\nAnd the difference between the chosen goodie with highest price and the lowest price is " + min_diff);
	  fw.close();
	  System.out.println("To view the output, Please check the output.txt file");
	  System.out.println("Incase to change the input value please make the necessary changes in input.txt file");
  }
}